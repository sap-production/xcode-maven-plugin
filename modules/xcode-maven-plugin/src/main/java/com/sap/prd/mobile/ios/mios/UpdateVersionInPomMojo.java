  ...
  private String getXCodeVersion() throws XCodeException
  {
    ...
    for (String configuration : getConfigurations()) {
      for (String sdk : getSDKs()) {
        ...
        String infoPListFileName = EffectiveBuildSettings.getBuildSetting(getXCodeContext(XCodeContext.SourceCodeLocation.WORKING_COPY), configuration, sdk, EffectiveBuildSettings.INFOPLIST_FILE);
