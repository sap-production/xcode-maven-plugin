  ...
  public void execute() throws MojoExecutionException, MojoFailureException
  {
    ...
    try {
      ...
      if(originalLibDir.exists()) {
        if(useSymbolicLinks()) {
          com.sap.prd.mobile.ios.mios.FileUtils.createSymbolicLink(originalLibDir.getParentFile(), originalLibDir, copyOfLibDir.getName());
        } else {
      ...
      if(originalHeadersDir.exists()) {
        if(useSymbolicLinks) {
          com.sap.prd.mobile.ios.mios.FileUtils.createSymbolicLink(originalHeadersDir.getParentFile(), originalHeadersDir, copyOfHeadersDir.getName());
        } else {
      ...
      if(originalXcodeDepsDir.exists()) {
        if(useSymbolicLinks) {
          com.sap.prd.mobile.ios.mios.FileUtils.createSymbolicLink(originalXcodeDepsDir.getParentFile(), originalXcodeDepsDir, copyOfXcodeDepsDir.getName());
        } else {
