...
static void changeAppIdForExtension(PListAccessor infoPlistAccessor, String appIdSuffix, String appType) throws MojoExecutionException {
		...
		try {
			...
			LOGGER.info("For current project: \n WatchApp Bundle Identifier Value: "+getWKAppBundleIdentifier());
