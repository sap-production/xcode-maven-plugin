...
public class XCodeVerificationCheckMojo extends BuildContextAwareMojo
{
  ...
  {
    static Location getLocation(final String locationUriString) throws InvalidProtocolException, MalformedURLException
    {
      final URL url = new URL(locationUriString.trim());
